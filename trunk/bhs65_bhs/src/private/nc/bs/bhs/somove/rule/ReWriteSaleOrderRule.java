 ...
 * 20171018
 */
public class ReWriteSaleOrderRule implements IRule<AggSoMoveHVO>{

	@Override
	public void process(AggSoMoveHVO[] aggvos) {
		// TODO 自动生成的方法存根
		for (int i = 0; i < aggvos.length; i++) {
			execute(aggvos[i]);
		}
	}
	public void execute(AggSoMoveHVO aggvo){
		SoMoveHVO headvo = aggvo.getParentVO();
		...
		hvo.setAttributeValue("contractno", headvo.getContactpersphone());
