...
public class SoTruckTEsedBVO extends SuperVO {
...
*WEIGHT
*/
public UFDouble cntrweight;
/**
*READY TO TRUCK OUT
*/
public UFDate readytotruckout;
/**
*上层单据主键
*/
...
/**
* 属性pmin的Setter方法.属性名：PM IN
* 创建日期:2017-10-18
* @param newPmin java.lang.String
*/
...
/**
* 属性trno的Setter方法.属性名：TR #
* 创建日期:2017-10-18
* @param newTrno java.lang.String
*/
...
/**
* 属性 dateout的Getter方法.属性名：DATE OUT
*  创建日期:2017-10-18
* @return nc.vo.pub.lang.UFDate
*/
public UFDate getDateout() {
return this.dateout;
} 

/**
* 属性dateout的Setter方法.属性名：DATE OUT
* 创建日期:2017-10-18
* @param newDateout nc.vo.pub.lang.UFDate
*/
public void setDateout ( UFDate dateout) {
this.dateout=dateout;
} 
 
/**
* 属性 pmout的Getter方法.属性名：PM OUT
*  创建日期:2017-10-18
* @return java.lang.String
*/
...
/**
* 属性pmout的Setter方法.属性名：PM OUT
* 创建日期:2017-10-18
* @param newPmout java.lang.String
*/
...
/**
* 属性 cntrno的Getter方法.属性名：CNTR NO.
*  创建日期:2017-10-18
* @return java.lang.String
*/
...
/**
* 属性cntrno的Setter方法.属性名：CNTR NO.
* 创建日期:2017-10-18
* @param newCntrno java.lang.String
*/
...
/**
* 属性 cntrweight的Getter方法.属性名：WEIGHT
*  创建日期:2017-10-18
* @return nc.vo.pub.lang.UFDouble
*/
public UFDouble getCntrweight() {
return this.cntrweight;
} 

/**
* 属性cntrweight的Setter方法.属性名：WEIGHT
* 创建日期:2017-10-18
* @param newCntrweight nc.vo.pub.lang.UFDouble
*/
public void setCntrweight ( UFDouble cntrweight) {
this.cntrweight=cntrweight;
} 
 
/**
* 属性 readytotruckout的Getter方法.属性名：READY TO TRUCK OUT
*  创建日期:2017-10-18
* @return nc.vo.pub.lang.UFDate
*/
public UFDate getReadytotruckout() {
return this.readytotruckout;
} 

/**
* 属性readytotruckout的Setter方法.属性名：READY TO TRUCK OUT
* 创建日期:2017-10-18
* @param newReadytotruckout nc.vo.pub.lang.UFDate
*/
public void setReadytotruckout ( UFDate readytotruckout) {
this.readytotruckout=readytotruckout;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("BHS.SoTruckTEsedBVO");
    }
   }
