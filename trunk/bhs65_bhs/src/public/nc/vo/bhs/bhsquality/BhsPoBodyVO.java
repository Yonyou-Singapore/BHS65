...
public class BhsPoBodyVO extends SuperVO {
...
*Psnpon
*/
public String pk_psnpon;
/**
*Punitive Measure
*/
public String punitivemeasure;
/**
*上层单据主键
*/
...
/**
* 属性 pk_psnpon的Getter方法.属性名：Psnpon
*  创建日期:2017-4-9
* @return nc.vo.bd.psn.PsndocVO
*/
public String getPk_psnpon() {
return this.pk_psnpon;
} 

/**
* 属性pk_psnpon的Setter方法.属性名：Psnpon
* 创建日期:2017-4-9
* @param newPk_psnpon nc.vo.bd.psn.PsndocVO
*/
public void setPk_psnpon ( String pk_psnpon) {
this.pk_psnpon=pk_psnpon;
} 
 
/**
* 属性 punitivemeasure的Getter方法.属性名：Punitive Measure
*  创建日期:2017-4-9
* @return java.lang.String
*/
public String getPunitivemeasure() {
return this.punitivemeasure;
} 

/**
* 属性punitivemeasure的Setter方法.属性名：Punitive Measure
* 创建日期:2017-4-9
* @param newPunitivemeasure java.lang.String
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("bhs.BhsPoBodyVO");
    }
   }
