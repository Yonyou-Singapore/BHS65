...
import nc.ui.so.salequotation.handler.body.TermEditHandler;
...
public class SalequoBodyAfterEditHandler implements
  ...
  public void handleAppEvent(CardBodyAfterEditEvent e) {
    ...
    if (SalequotationTermVO.TERMCODE.equals(e.getKey())){
    	TermEditHandler termedithandler = new TermEditHandler();
    	termedithandler.afterEdit(e);
    }
    // 物料
