...
public class receivablebill_base extends AbstractJavaBeanDefinition{
...
private List getManagedList0(){  List list = new ArrayList();  list.add(getQueryParam_c6e497());  list.add(getQueryParam_1c9af59());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_c6e497(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#c6e497")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#c6e497");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#c6e497",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1c9af59(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1c9af59")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1c9af59");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1c9af59",bean);
...
public nc.ui.arap.view.ArapBillCardForm getBillFormEditor(){
 ...
 return (nc.ui.arap.view.ArapBillCardForm)context.get("billFormEditor");
  ...
  bean.setBlankChildrenFilter(getSingleFieldBlankChildrenFilter_17052e());
  bean.setDefValueItf(getBillDefVauleItf());
  bean.setBodyLineActions(getManagedList2());
  bean.setActions(getManagedList5());
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_8a888f());
  bean.initRealUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter getSingleFieldBlankChildrenFilter_17052e(){
 if(context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#17052e")!=null)
 return (nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter)context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#17052e");
  ...
  context.put("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#17052e",bean);
...
private List getManagedList2(){  List list = new ArrayList();  list.add(getAddLineAction());  list.add(getInsertLineAction_1553816());  list.add(getBodyDelLineAction_1d53851());  list.add(getBodyCopyLineAction_1647cf1());  list.add(getBodyPasteLineAction_46b80e());  list.add(getBodyPasteToTailAction_ddd9bf());  list.add(getActionsBarSeparator());  list.add(getBodyLineEditAction_1028b0a());  list.add(getActionsBarSeparator());  list.add(getBillBodyZoomAction_1f67155());  return list;}

private nc.ui.arap.actions.InsertLineAction getInsertLineAction_1553816(){
 if(context.get("nc.ui.arap.actions.InsertLineAction#1553816")!=null)
 return (nc.ui.arap.actions.InsertLineAction)context.get("nc.ui.arap.actions.InsertLineAction#1553816");
  nc.ui.arap.actions.InsertLineAction bean = new nc.ui.arap.actions.InsertLineAction();
  context.put("nc.ui.arap.actions.InsertLineAction#1553816",bean);
...
private nc.ui.arap.actions.BodyDelLineAction getBodyDelLineAction_1d53851(){
 if(context.get("nc.ui.arap.actions.BodyDelLineAction#1d53851")!=null)
 return (nc.ui.arap.actions.BodyDelLineAction)context.get("nc.ui.arap.actions.BodyDelLineAction#1d53851");
  nc.ui.arap.actions.BodyDelLineAction bean = new nc.ui.arap.actions.BodyDelLineAction();
  context.put("nc.ui.arap.actions.BodyDelLineAction#1d53851",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.arap.actions.BodyCopyLineAction getBodyCopyLineAction_1647cf1(){
 if(context.get("nc.ui.arap.actions.BodyCopyLineAction#1647cf1")!=null)
 return (nc.ui.arap.actions.BodyCopyLineAction)context.get("nc.ui.arap.actions.BodyCopyLineAction#1647cf1");
  nc.ui.arap.actions.BodyCopyLineAction bean = new nc.ui.arap.actions.BodyCopyLineAction();
  context.put("nc.ui.arap.actions.BodyCopyLineAction#1647cf1",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.arap.actions.BodyPasteLineAction getBodyPasteLineAction_46b80e(){
 if(context.get("nc.ui.arap.actions.BodyPasteLineAction#46b80e")!=null)
 return (nc.ui.arap.actions.BodyPasteLineAction)context.get("nc.ui.arap.actions.BodyPasteLineAction#46b80e");
  nc.ui.arap.actions.BodyPasteLineAction bean = new nc.ui.arap.actions.BodyPasteLineAction();
  context.put("nc.ui.arap.actions.BodyPasteLineAction#46b80e",bean);
...
private nc.ui.arap.actions.BodyPasteToTailAction getBodyPasteToTailAction_ddd9bf(){
 if(context.get("nc.ui.arap.actions.BodyPasteToTailAction#ddd9bf")!=null)
 return (nc.ui.arap.actions.BodyPasteToTailAction)context.get("nc.ui.arap.actions.BodyPasteToTailAction#ddd9bf");
  nc.ui.arap.actions.BodyPasteToTailAction bean = new nc.ui.arap.actions.BodyPasteToTailAction();
  context.put("nc.ui.arap.actions.BodyPasteToTailAction#ddd9bf",bean);
...
private nc.ui.arap.actions.BodyLineEditAction getBodyLineEditAction_1028b0a(){
 if(context.get("nc.ui.arap.actions.BodyLineEditAction#1028b0a")!=null)
 return (nc.ui.arap.actions.BodyLineEditAction)context.get("nc.ui.arap.actions.BodyLineEditAction#1028b0a");
  nc.ui.arap.actions.BodyLineEditAction bean = new nc.ui.arap.actions.BodyLineEditAction();
  context.put("nc.ui.arap.actions.BodyLineEditAction#1028b0a",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.arap.actions.BillBodyZoomAction getBillBodyZoomAction_1f67155(){
 if(context.get("nc.ui.arap.actions.BillBodyZoomAction#1f67155")!=null)
 return (nc.ui.arap.actions.BillBodyZoomAction)context.get("nc.ui.arap.actions.BillBodyZoomAction#1f67155");
  nc.ui.arap.actions.BillBodyZoomAction bean = new nc.ui.arap.actions.BillBodyZoomAction();
  context.put("nc.ui.arap.actions.BillBodyZoomAction#1f67155",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_8a888f(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#8a888f")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#8a888f");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#8a888f",bean);
  bean.setContainer(getUserdefitemContainer());
...
public nc.ui.uif2.components.widget.BesideWidget getMultiBesideWidget(){
 if(context.get("multiBesideWidget")!=null)
 return (nc.ui.uif2.components.widget.BesideWidget)context.get("multiBesideWidget");
  nc.ui.uif2.components.widget.BesideWidget bean = new nc.ui.uif2.components.widget.BesideWidget();
  context.put("multiBesideWidget",bean);
  bean.setBesideWidgetlets(getManagedList8());
  bean.setContext(getContext());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
public nc.ui.arap.actions.ArapAddFlowMenuAciton getAddActionGroup(){
 ...
 return (nc.ui.arap.actions.ArapAddFlowMenuAciton)context.get("addActionGroup");
  ...
  bean.setOrgChangedImpl(getOrgchange());
  bean.setCode("add");
  bean.setName(getI18nFB_1bc4b18());
...
private java.lang.String getI18nFB_1bc4b18(){
 if(context.get("nc.ui.uif2.I18nFB#1bc4b18")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1bc4b18");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1bc4b18",bean);  bean.setResDir("pubapp_0");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#1bc4b18",product);
...
public nc.ui.arap.view.ArapTransferBillViewProcessor getTransferProcessor(){
 ...
 return (nc.ui.arap.view.ArapTransferBillViewProcessor)context.get("transferProcessor");
  ...
  bean.setActionContainer((nc.ui.uif2.actions.IActionContributor)findBeanInUIF2BeanFactory("listActions"));
  bean.setBillForm(getBillFormEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private List getManagedList11(){  List list = new ArrayList();  list.add((nc.ui.uif2.actions.IActionContributor)findBeanInUIF2BeanFactory("listActions"));  list.add((nc.ui.uif2.actions.IActionContributor)findBeanInUIF2BeanFactory("cardActions"));  list.add(getVerifyActions());  list.add(getMakeupActions());  return list;}
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_170c0a1());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_170c0a1(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#170c0a1")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#170c0a1");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#170c0a1",bean);
...
private List getManagedList12(){  List list = new ArrayList();   list.add(getHSNode_fee714());  list.add(getVSNode_196640d());  list.add(getCNode_b7f0a1()); list.add(getCNode_1c3b2b());  return list;}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_b7f0a1(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#b7f0a1")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#b7f0a1");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#b7f0a1",bean);
  bean.setName(getI18nFB_e648d6());
...
private java.lang.String getI18nFB_e648d6(){
 if(context.get("nc.ui.uif2.I18nFB#e648d6")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#e648d6");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#e648d6",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#e648d6",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_fee714(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#fee714")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#fee714");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#fee714",bean);
  bean.setLeft(getCNode_16fc3f());
  bean.setRight(getVSNode_c7eaa8());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_16fc3f(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#16fc3f")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#16fc3f");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#16fc3f",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_c7eaa8(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#c7eaa8")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#c7eaa8");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#c7eaa8",bean);
  bean.setUp(getCNode_10aa9e4());
  bean.setDown(getCNode_1e3bde4());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_10aa9e4(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#10aa9e4")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#10aa9e4");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#10aa9e4",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1e3bde4(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1e3bde4")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1e3bde4");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1e3bde4",bean);
  bean.setName(getI18nFB_117d604());
...
private java.lang.String getI18nFB_117d604(){
 if(context.get("nc.ui.uif2.I18nFB#117d604")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#117d604");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#117d604",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#117d604",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_196640d(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#196640d")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#196640d");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#196640d",bean);
  bean.setUp(getCNode_f4dac3());
  bean.setDown(getCNode_176e0a4());
  bean.setShowMode("NoDivider");
  bean.setDividerLocation(30f);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_f4dac3(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#f4dac3")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#f4dac3");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#f4dac3",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_176e0a4(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#176e0a4")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#176e0a4");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#176e0a4",bean);
  bean.setName(getI18nFB_14660b4());
...
private java.lang.String getI18nFB_14660b4(){
 if(context.get("nc.ui.uif2.I18nFB#14660b4")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#14660b4");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#14660b4",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#14660b4",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_1c3b2b(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1c3b2b")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1c3b2b");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1c3b2b",bean);
  bean.setName(getI18nFB_82a8dc());
...
private java.lang.String getI18nFB_82a8dc(){
 if(context.get("nc.ui.uif2.I18nFB#82a8dc")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#82a8dc");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#82a8dc",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#82a8dc",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList13(){  List list = new ArrayList();  list.add(getDocumentManage());  list.add(getActionsBarSeparator());  list.add(getFirstLineAction());  list.add(getPreLineAction());  list.add(getNextLineAction());  list.add(getLastLineAction());  list.add(getActionsBarSeparator());  list.add(getBillHeadZoomAction_176a676());  return list;}

private nc.ui.arap.actions.BillHeadZoomAction getBillHeadZoomAction_176a676(){
 if(context.get("nc.ui.arap.actions.BillHeadZoomAction#176a676")!=null)
 return (nc.ui.arap.actions.BillHeadZoomAction)context.get("nc.ui.arap.actions.BillHeadZoomAction#176a676");
  nc.ui.arap.actions.BillHeadZoomAction bean = new nc.ui.arap.actions.BillHeadZoomAction();
  context.put("nc.ui.arap.actions.BillHeadZoomAction#176a676",bean);
  bean.setModel(getManageAppModel());
  bean.setBillForm(getBillFormEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
public nc.ui.arap.view.ArapBillCardForm getMakeupEditor(){
 ...
 return (nc.ui.arap.view.ArapBillCardForm)context.get("makeupEditor");
  ...
  bean.setAutoAddLine(false);
  bean.setTemplateNotNullValidate(true);
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_aab3ae());
  bean.initRealUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_aab3ae(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#aab3ae")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#aab3ae");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#aab3ae",bean);
  bean.setContainer(getUserdefitemContainer());
...
public nc.funcnode.ui.action.MenuAction getBillOperateActionGroup(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billOperateActionGroup");
  ...
  bean.setName(getI18nFB_14f57bd());
...
private java.lang.String getI18nFB_14f57bd(){
 if(context.get("nc.ui.uif2.I18nFB#14f57bd")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#14f57bd");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#14f57bd",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#14f57bd",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList18(){  List list = new ArrayList();  list.add(getDeleteAction());  list.add(getEditAction());  list.add(getTempSaveAction());  list.add(getWriteBack());  list.add(getDocumentManage());  return list;}
...
private java.lang.String getI18nFB_939f7(){
 if(context.get("nc.ui.uif2.I18nFB#939f7")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#939f7");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#939f7",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0137");
  bean.setDefaultValue("单据操作");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#939f7",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getBillOperateActionGroup_Init(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billOperateActionGroup_Init");
  ...
  bean.setCode("billOperate");
  bean.setName(getI18nFB_1bc8725());
...
private java.lang.String getI18nFB_1bc8725(){
 if(context.get("nc.ui.uif2.I18nFB#1bc8725")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1bc8725");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1bc8725",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0137");
  bean.setDefaultValue("单据操作");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1bc8725",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_4cbe37(){
 if(context.get("nc.ui.uif2.I18nFB#4cbe37")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#4cbe37");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#4cbe37",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0137");
  bean.setDefaultValue("单据操作");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#4cbe37",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_5c0f15(){
 if(context.get("nc.ui.uif2.I18nFB#5c0f15")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#5c0f15");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#5c0f15",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#5c0f15",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getBillApproveActionGroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("billApproveActionGroup");
  ...
  bean.setName(getI18nFB_1e251d6());
...
private java.lang.String getI18nFB_1e251d6(){
 if(context.get("nc.ui.uif2.I18nFB#1e251d6")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1e251d6");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1e251d6",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1e251d6",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getBillApproveActionGroup_List(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("billApproveActionGroup_List");
  ...
  bean.setName(getI18nFB_16aeace());
...
private java.lang.String getI18nFB_16aeace(){
 if(context.get("nc.ui.uif2.I18nFB#16aeace")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#16aeace");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#16aeace",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0142");
  bean.setDefaultValue("审批");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#16aeace",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_5da424(){
 if(context.get("nc.ui.uif2.I18nFB#5da424")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#5da424");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#5da424",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#5da424",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getPauseTransactActionGroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("pauseTransactActionGroup");
  ...
  bean.setName(getI18nFB_1c35986());
...
private java.lang.String getI18nFB_1c35986(){
 if(context.get("nc.ui.uif2.I18nFB#1c35986")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1c35986");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1c35986",bean);  bean.setResDir("2006pub_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1c35986",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_2a7586(){
 if(context.get("nc.ui.uif2.I18nFB#2a7586")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#2a7586");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#2a7586",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#2a7586",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getPrintOperateActionGroup_List(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("printOperateActionGroup_List");
  ...
  bean.setName(getI18nFB_189c91e());
...
private java.lang.String getI18nFB_189c91e(){
 if(context.get("nc.ui.uif2.I18nFB#189c91e")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#189c91e");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#189c91e",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0139");
  bean.setDefaultValue("打印");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#189c91e",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_f2eb01(){
 if(context.get("nc.ui.uif2.I18nFB#f2eb01")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#f2eb01");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#f2eb01",bean);  bean.setResDir("pubapp_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#f2eb01",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList29(){  List list = new ArrayList();  list.add(getLinkQueryAction());  list.add(getBalanceLinkQueryAction());  list.add(getDealLinkQueryAction());  list.add(getLinkVoucharQueryAction());  list.add(getBconferQueryAction());  list.add(getTermLinkQueryAction());  list.add(getTbbLinkAction());  return list;}
...
public nc.ui.arap.actions.BillListApproveAction getApproveListActionReal(){
 ...
 return (nc.ui.arap.actions.BillListApproveAction)context.get("ApproveListActionReal");
  ...
  bean.setIsbatch("N");
  bean.setInterceptor(getInterceptor());
  bean.setTpaProgressUtil(getTPAProgressUtil_229c79());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.uif2.components.progress.TPAProgressUtil getTPAProgressUtil_229c79(){
 if(context.get("nc.ui.uif2.components.progress.TPAProgressUtil#229c79")!=null)
 return (nc.ui.uif2.components.progress.TPAProgressUtil)context.get("nc.ui.uif2.components.progress.TPAProgressUtil#229c79");
  nc.ui.uif2.components.progress.TPAProgressUtil bean = new nc.ui.uif2.components.progress.TPAProgressUtil();
  context.put("nc.ui.uif2.components.progress.TPAProgressUtil#229c79",bean);
  bean.setContext(getContext());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.arap.actions.BillListApproveAction getApproveListBatchActionReal(){
 ...
 return (nc.ui.arap.actions.BillListApproveAction)context.get("ApproveListBatchActionReal");
  ...
  bean.setIsbatch("Y");
  bean.setInterceptor(getInterceptor());
  bean.setTpaProgressUtil(getTPAProgressUtil_4eedda());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.uif2.components.progress.TPAProgressUtil getTPAProgressUtil_4eedda(){
 if(context.get("nc.ui.uif2.components.progress.TPAProgressUtil#4eedda")!=null)
 return (nc.ui.uif2.components.progress.TPAProgressUtil)context.get("nc.ui.uif2.components.progress.TPAProgressUtil#4eedda");
  nc.ui.uif2.components.progress.TPAProgressUtil bean = new nc.ui.uif2.components.progress.TPAProgressUtil();
  context.put("nc.ui.uif2.components.progress.TPAProgressUtil#4eedda",bean);
  bean.setContext(getContext());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private Map getManagedMap0(){  Map map = new HashMap();  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyBeforeEditEvent",getManagedList30());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyAfterEditEvent",getManagedList31());  map.put("nc.ui.arap.viewhandler.CardBodyAfterEditEvent",getManagedList32());  map.put("nc.ui.arap.viewhandler.cardafter.CardBodyAfterEditCalTaxEvent",getManagedList33());  map.put("nc.ui.arap.viewhandler.cardafter.CardBodyAfterEditTaxShowEvent",getManagedList34());  map.put("nc.ui.pubapp.uif2app.event.card.CardHeadTailBeforeEditEvent",getManagedList35());  map.put("nc.ui.pubapp.uif2app.event.card.CardHeadTailAfterEditEvent",getManagedList36());  map.put("nc.ui.pubapp.uif2app.event.card.CardPanelLoadEvent",getManagedList37());  map.put("nc.ui.pubapp.uif2app.event.list.ListPanelLoadEvent",getManagedList38());  map.put("nc.ui.pubapp.uif2app.event.list.ListHeadRowChangedEvent",getManagedList39());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyRowChangedEvent",getManagedList40());  map.put("nc.ui.pubapp.uif2app.event.list.ListHeadDataChangedEvent",getManagedList41());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyAfterRowEditEvent",getManagedList42());  map.put("nc.ui.pubapp.uif2app.mediator.mutiltrans.NodekeyEvent",getManagedList43());  return map;}

private List getManagedList30(){  List list = new ArrayList();  list.add(getBodyBankAccBeforeEditHandler());  list.add(getBodyAccountRefBeforeEditHandler());  list.add(getBodyFreeCustBeforeEditHandler());  list.add(getBodyProjectBeforeEditHandler());  list.add(getOtherOrgBodyBeforeEditHandler());  list.add(getPayTermBodyBeforeEditHandler());  list.add(getBodyCrossCheckBeforeHandler());  list.add(getBodySummaryBeforeEditHandler());  list.add(getBodyVersionRefBeforeEditHandler());  list.add(getBodySoBilltypeBeforeEditHandler());  list.add(getBodyCostCenterRefBeforeEditHandler());  list.add(getBodyTaxcodeBeforeEditHandler());  list.add(getBodyPsnDocBeforeEditHandler());  return list;}

private List getManagedList31(){  List list = new ArrayList();  list.add(getBodyAutoAddLineBeforeEditHandler());  list.add(getBodyMaterialAfterEditHandler());  list.add(getBodyPsnDocAfterEditHandler());  list.add(getBodyCurrTypeAfterEditHandler());  list.add(getBodyLocalMoneyAfterEditHandler());  list.add(getBodyRateAfterEditHandler());  list.add(getCardAfterEditCalculateHandler());  list.add(getBodyEuroAfterEditHandler());  list.add(getOtherOrgBodyAfterEditHandler());  list.add(getBodyMoneyBalanceAfterEditHandler());  list.add(getBodyMoneyBalanceAfterEditHandler());  list.add(getEnableCtrlBodyAfterEditHandler());  list.add(getBodyFundplanAfterEditHandler());  list.add(getBodyCuspAfterEditHandler());  list.add(getBodyBankAccAfterEditHandler());  list.add(getBodyDeptAfterEditHandler());  list.add(getBodyVersionRefAfterEditHandler());  list.add(getBodyCostCenterAfterEditHandler());  return list;}
...
private List getManagedList33(){  List list = new ArrayList();  list.add(getCardAfterEditCalculateHandler());  return list;}

private List getManagedList34(){  List list = new ArrayList();  list.add(getTaxForm());  return list;}
...
private List getManagedList40(){  List list = new ArrayList();  list.add(getCardBodyRowChangeHandler());  list.add(getSideFormMediator());  return list;}

private List getManagedList41(){  List list = new ArrayList();  list.add(getListHeadModelListener());  return list;}

private List getManagedList42(){  List list = new ArrayList();  list.add(getCardBodyAfterRowEditHandler());  return list;}
...
public nc.funcnode.ui.action.MenuAction getBillAssistantActionGroup(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billAssistantActionGroup");
  ...
  bean.setName(getI18nFB_1e1bbc9());
...
private java.lang.String getI18nFB_1e1bbc9(){
 if(context.get("nc.ui.uif2.I18nFB#1e1bbc9")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1e1bbc9");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1e1bbc9",bean);  bean.setResDir("2006pub_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1e1bbc9",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList44(){  List list = new ArrayList();  list.add(getDocumentManage());  list.add(getTaxinfoLinkQueryAction());  return list;}
...
private java.lang.String getI18nFB_efcab6(){
 if(context.get("nc.ui.uif2.I18nFB#efcab6")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#efcab6");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#efcab6",bean);  bean.setResDir("2006pub_0");
  bean.setResId("02006pub-0643");
  bean.setDefaultValue("辅助功能");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#efcab6",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList45(){  List list = new ArrayList();  return list;}
