...
public class receivablebill_manage extends AbstractJavaBeanDefinition{
...
private List getManagedList0(){  List list = new ArrayList();  list.add(getQueryParam_1ab8e2f());  list.add(getQueryParam_3dda7());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1ab8e2f(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1ab8e2f")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1ab8e2f");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1ab8e2f",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_3dda7(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#3dda7")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#3dda7");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#3dda7",bean);
...
public nc.ui.arap.view.ArapBillCardForm getBillFormEditor(){
 ...
 return (nc.ui.arap.view.ArapBillCardForm)context.get("billFormEditor");
  ...
  bean.setBlankChildrenFilter(getSingleFieldBlankChildrenFilter_1cd0621());
  bean.setDefValueItf(getBillDefVauleItf());
  bean.setBodyLineActions(getManagedList2());
  bean.setActions(getManagedList5());
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_1bee524());
  bean.initRealUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter getSingleFieldBlankChildrenFilter_1cd0621(){
 if(context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#1cd0621")!=null)
 return (nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter)context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#1cd0621");
  ...
  context.put("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#1cd0621",bean);
...
private List getManagedList2(){  List list = new ArrayList();  list.add(getAddLineAction());  list.add(getInsertLineAction_14d70d6());  list.add(getBodyDelLineAction_12b1940());  list.add(getBodyCopyLineAction_86c4a2());  list.add(getBodyPasteLineAction_1d76f21());  list.add(getBodyPasteToTailAction_c0f917());  list.add(getActionsBarSeparator());  list.add(getBodyLineEditAction_1217116());  list.add(getActionsBarSeparator());  list.add(getBillBodyZoomAction_8777a0());  return list;}

private nc.ui.arap.actions.InsertLineAction getInsertLineAction_14d70d6(){
 if(context.get("nc.ui.arap.actions.InsertLineAction#14d70d6")!=null)
 return (nc.ui.arap.actions.InsertLineAction)context.get("nc.ui.arap.actions.InsertLineAction#14d70d6");
  nc.ui.arap.actions.InsertLineAction bean = new nc.ui.arap.actions.InsertLineAction();
  context.put("nc.ui.arap.actions.InsertLineAction#14d70d6",bean);
...
private nc.ui.arap.actions.BodyDelLineAction getBodyDelLineAction_12b1940(){
 if(context.get("nc.ui.arap.actions.BodyDelLineAction#12b1940")!=null)
 return (nc.ui.arap.actions.BodyDelLineAction)context.get("nc.ui.arap.actions.BodyDelLineAction#12b1940");
  nc.ui.arap.actions.BodyDelLineAction bean = new nc.ui.arap.actions.BodyDelLineAction();
  context.put("nc.ui.arap.actions.BodyDelLineAction#12b1940",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.arap.actions.BodyCopyLineAction getBodyCopyLineAction_86c4a2(){
 if(context.get("nc.ui.arap.actions.BodyCopyLineAction#86c4a2")!=null)
 return (nc.ui.arap.actions.BodyCopyLineAction)context.get("nc.ui.arap.actions.BodyCopyLineAction#86c4a2");
  nc.ui.arap.actions.BodyCopyLineAction bean = new nc.ui.arap.actions.BodyCopyLineAction();
  context.put("nc.ui.arap.actions.BodyCopyLineAction#86c4a2",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.arap.actions.BodyPasteLineAction getBodyPasteLineAction_1d76f21(){
 if(context.get("nc.ui.arap.actions.BodyPasteLineAction#1d76f21")!=null)
 return (nc.ui.arap.actions.BodyPasteLineAction)context.get("nc.ui.arap.actions.BodyPasteLineAction#1d76f21");
  nc.ui.arap.actions.BodyPasteLineAction bean = new nc.ui.arap.actions.BodyPasteLineAction();
  context.put("nc.ui.arap.actions.BodyPasteLineAction#1d76f21",bean);
...
private nc.ui.arap.actions.BodyPasteToTailAction getBodyPasteToTailAction_c0f917(){
 if(context.get("nc.ui.arap.actions.BodyPasteToTailAction#c0f917")!=null)
 return (nc.ui.arap.actions.BodyPasteToTailAction)context.get("nc.ui.arap.actions.BodyPasteToTailAction#c0f917");
  nc.ui.arap.actions.BodyPasteToTailAction bean = new nc.ui.arap.actions.BodyPasteToTailAction();
  context.put("nc.ui.arap.actions.BodyPasteToTailAction#c0f917",bean);
...
private nc.ui.arap.actions.BodyLineEditAction getBodyLineEditAction_1217116(){
 if(context.get("nc.ui.arap.actions.BodyLineEditAction#1217116")!=null)
 return (nc.ui.arap.actions.BodyLineEditAction)context.get("nc.ui.arap.actions.BodyLineEditAction#1217116");
  nc.ui.arap.actions.BodyLineEditAction bean = new nc.ui.arap.actions.BodyLineEditAction();
  context.put("nc.ui.arap.actions.BodyLineEditAction#1217116",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.arap.actions.BillBodyZoomAction getBillBodyZoomAction_8777a0(){
 if(context.get("nc.ui.arap.actions.BillBodyZoomAction#8777a0")!=null)
 return (nc.ui.arap.actions.BillBodyZoomAction)context.get("nc.ui.arap.actions.BillBodyZoomAction#8777a0");
  nc.ui.arap.actions.BillBodyZoomAction bean = new nc.ui.arap.actions.BillBodyZoomAction();
  context.put("nc.ui.arap.actions.BillBodyZoomAction#8777a0",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_1bee524(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#1bee524")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#1bee524");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#1bee524",bean);
  bean.setContainer(getUserdefitemContainer());
...
private Map getManagedMap0(){  Map map = new HashMap();  map.put(getI18nFB_1d34c83(),getManagedList8());  map.put(getI18nFB_14443f6(),getManagedList9());  return map;}

private java.lang.String getI18nFB_1d34c83(){
 if(context.get("nc.ui.uif2.I18nFB#1d34c83")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1d34c83");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1d34c83",bean);  bean.setResDir("uif2");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#1d34c83",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList8(){  List list = new ArrayList();  list.add(getCreditForm());  return list;}

private java.lang.String getI18nFB_14443f6(){
 if(context.get("nc.ui.uif2.I18nFB#14443f6")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#14443f6");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#14443f6",bean);  bean.setResDir("uif2");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#14443f6",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList9(){  List list = new ArrayList();  list.add(getBesideApproveForm());  list.add(getBesideHistoryForm());  return list;}
...
private java.lang.String getI18nFB_c4378f(){
 if(context.get("nc.ui.uif2.I18nFB#c4378f")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#c4378f");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#c4378f",bean);  bean.setResDir("pubapp_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#c4378f",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_1b1609e());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_1b1609e(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#1b1609e")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#1b1609e");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#1b1609e",bean);
...
private List getManagedList13(){  List list = new ArrayList();  list.add(getHSNode_57f4d());  list.add(getVSNode_ae7c74());  list.add(getCNode_1c6f0b5());  list.add(getCNode_9035a3());  return list;}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_57f4d(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#57f4d")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#57f4d");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#57f4d",bean);
  bean.setLeft(getCNode_1bc0f8());
  bean.setRight(getVSNode_169d0b6());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1bc0f8(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1bc0f8")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1bc0f8");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1bc0f8",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_169d0b6(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#169d0b6")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#169d0b6");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#169d0b6",bean);
  bean.setUp(getCNode_19e104());
  bean.setDown(getCNode_11e41ad());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_19e104(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#19e104")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#19e104");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#19e104",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_11e41ad(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#11e41ad")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#11e41ad");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#11e41ad",bean);
  bean.setName(getI18nFB_103ee7c());
...
private java.lang.String getI18nFB_103ee7c(){
 if(context.get("nc.ui.uif2.I18nFB#103ee7c")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#103ee7c");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#103ee7c",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#103ee7c",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_ae7c74(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#ae7c74")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#ae7c74");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#ae7c74",bean);
  bean.setUp(getCNode_e8c560());
  bean.setDown(getCNode_be1277());
  bean.setShowMode("NoDivider");
  bean.setDividerLocation(30f);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_e8c560(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#e8c560")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#e8c560");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#e8c560",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_be1277(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#be1277")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#be1277");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#be1277",bean);
  bean.setName(getI18nFB_1f64b1f());
...
private java.lang.String getI18nFB_1f64b1f(){
 if(context.get("nc.ui.uif2.I18nFB#1f64b1f")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1f64b1f");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1f64b1f",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1f64b1f",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_1c6f0b5(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1c6f0b5")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1c6f0b5");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1c6f0b5",bean);
  bean.setName(getI18nFB_16ccc07());
...
private java.lang.String getI18nFB_16ccc07(){
 if(context.get("nc.ui.uif2.I18nFB#16ccc07")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#16ccc07");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#16ccc07",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#16ccc07",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_9035a3(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#9035a3")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#9035a3");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#9035a3",bean);
  bean.setName(getI18nFB_1e53361());
...
private java.lang.String getI18nFB_1e53361(){
 if(context.get("nc.ui.uif2.I18nFB#1e53361")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1e53361");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1e53361",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1e53361",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList14(){  List list = new ArrayList();  list.add(getDocumentManage());  list.add(getActionsBarSeparator());  list.add(getFirstLineAction());  list.add(getPreLineAction());  list.add(getNextLineAction());  list.add(getLastLineAction());  list.add(getActionsBarSeparator());  list.add(getBillHeadZoomAction_3e6483());  return list;}

private nc.ui.arap.actions.BillHeadZoomAction getBillHeadZoomAction_3e6483(){
 if(context.get("nc.ui.arap.actions.BillHeadZoomAction#3e6483")!=null)
 return (nc.ui.arap.actions.BillHeadZoomAction)context.get("nc.ui.arap.actions.BillHeadZoomAction#3e6483");
  nc.ui.arap.actions.BillHeadZoomAction bean = new nc.ui.arap.actions.BillHeadZoomAction();
  context.put("nc.ui.arap.actions.BillHeadZoomAction#3e6483",bean);
  bean.setModel(getManageAppModel());
  bean.setBillForm(getBillFormEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
public nc.ui.arap.view.ArapBillCardForm getMakeupEditor(){
 ...
 return (nc.ui.arap.view.ArapBillCardForm)context.get("makeupEditor");
  ...
  bean.setAutoAddLine(false);
  bean.setTemplateNotNullValidate(true);
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_38f254());
  bean.initRealUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_38f254(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#38f254")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#38f254");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#38f254",bean);
  bean.setContainer(getUserdefitemContainer());
...
public nc.ui.arap.actions.CreditCheckDecoratorAction getDeleteAction(){
 ...
 return (nc.ui.arap.actions.CreditCheckDecoratorAction)context.get("deleteAction");
  nc.ui.arap.actions.CreditCheckDecoratorAction bean = new nc.ui.arap.actions.CreditCheckDecoratorAction(getDeleteActionReal());  context.put("deleteAction",bean);
  bean.setModel(getManageAppModel());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.arap.actions.CreditCheckDecoratorAction getApproveAction(){
 ...
 return (nc.ui.arap.actions.CreditCheckDecoratorAction)context.get("ApproveAction");
  nc.ui.arap.actions.CreditCheckDecoratorAction bean = new nc.ui.arap.actions.CreditCheckDecoratorAction(getApproveActionReal());  context.put("ApproveAction",bean);
  bean.setModel(getManageAppModel());
  bean.setInterceptor(getInterceptor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
public nc.ui.arap.actions.CreditCheckDecoratorAction getApproveListBatchAction(){
 ...
 return (nc.ui.arap.actions.CreditCheckDecoratorAction)context.get("ApproveListBatchAction");
  nc.ui.arap.actions.CreditCheckDecoratorAction bean = new nc.ui.arap.actions.CreditCheckDecoratorAction(getApproveListBatchActionReal());  context.put("ApproveListBatchAction",bean);
  bean.setModel(getManageAppModel());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.arap.actions.CreditCheckDecoratorAction getApproveListAction(){
 ...
 return (nc.ui.arap.actions.CreditCheckDecoratorAction)context.get("ApproveListAction");
  nc.ui.arap.actions.CreditCheckDecoratorAction bean = new nc.ui.arap.actions.CreditCheckDecoratorAction(getApproveListActionReal());  context.put("ApproveListAction",bean);
  bean.setModel(getManageAppModel());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private java.lang.String getI18nFB_4848cc(){
 if(context.get("nc.ui.uif2.I18nFB#4848cc")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#4848cc");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#4848cc",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#4848cc",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getBillOperateActionGroup_Record(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billOperateActionGroup_Record");
  ...
  bean.setCode("billOperate");
  bean.setName(getI18nFB_1a3744e());
...
private java.lang.String getI18nFB_1a3744e(){
 if(context.get("nc.ui.uif2.I18nFB#1a3744e")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1a3744e");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1a3744e",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0137");
  bean.setDefaultValue("单据操作");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1a3744e",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_28d8ce(){
 if(context.get("nc.ui.uif2.I18nFB#28d8ce")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#28d8ce");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#28d8ce",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0137");
  bean.setDefaultValue("单据操作");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#28d8ce",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getBillOperateActionGroup_List(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billOperateActionGroup_List");
  ...
  bean.setName(getI18nFB_1b1ecad());
...
private java.lang.String getI18nFB_1b1ecad(){
 if(context.get("nc.ui.uif2.I18nFB#1b1ecad")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1b1ecad");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1b1ecad",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0137");
  bean.setDefaultValue("单据操作");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1b1ecad",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_2978ae(){
 if(context.get("nc.ui.uif2.I18nFB#2978ae")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#2978ae");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#2978ae",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#2978ae",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_b1eec5(){
 if(context.get("nc.ui.uif2.I18nFB#b1eec5")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#b1eec5");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#b1eec5",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#b1eec5",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getBillApproveActionGroup_List(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("billApproveActionGroup_List");
  ...
  bean.setName(getI18nFB_1b2eabe());
...
private java.lang.String getI18nFB_1b2eabe(){
 if(context.get("nc.ui.uif2.I18nFB#1b2eabe")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1b2eabe");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1b2eabe",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0142");
  bean.setDefaultValue("审批");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1b2eabe",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getBillVerifyActionGroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("billVerifyActionGroup");
  ...
  bean.setName(getI18nFB_151a06a());
...
private java.lang.String getI18nFB_151a06a(){
 if(context.get("nc.ui.uif2.I18nFB#151a06a")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#151a06a");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#151a06a",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#151a06a",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getPauseTransactActionGroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("pauseTransactActionGroup");
  ...
  bean.setName(getI18nFB_1fac738());
...
private java.lang.String getI18nFB_1fac738(){
 if(context.get("nc.ui.uif2.I18nFB#1fac738")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1fac738");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1fac738",bean);  bean.setResDir("2006pub_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1fac738",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getPrintOperateActionGroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("printOperateActionGroup");
  ...
  bean.setName(getI18nFB_12d32a6());
...
private java.lang.String getI18nFB_12d32a6(){
 if(context.get("nc.ui.uif2.I18nFB#12d32a6")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#12d32a6");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#12d32a6",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#12d32a6",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_58487c(){
 if(context.get("nc.ui.uif2.I18nFB#58487c")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#58487c");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#58487c",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0139");
  bean.setDefaultValue("打印");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#58487c",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getRelatedQueryActionGroup(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("relatedQueryActionGroup");
  ...
  bean.setName(getI18nFB_1fee5e4());
...
private java.lang.String getI18nFB_1fee5e4(){
 if(context.get("nc.ui.uif2.I18nFB#1fee5e4")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1fee5e4");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1fee5e4",bean);  bean.setResDir("pubapp_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1fee5e4",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList30(){  List list = new ArrayList();  list.add(getLinkQueryAction());  list.add(getBalanceLinkQueryAction());  list.add(getDealLinkQueryAction());  list.add(getLinkVoucharQueryAction());  list.add(getBconferQueryAction());  list.add(getTermLinkQueryAction());  list.add(getTbbLinkAction());  return list;}
...
public nc.funcnode.ui.action.MenuAction getReceiptMenuAction(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("receiptMenuAction");
  ...
  bean.setCode("billOperate");
  bean.setName(getI18nFB_1a70f05());
...
private java.lang.String getI18nFB_1a70f05(){
 if(context.get("nc.ui.uif2.I18nFB#1a70f05")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1a70f05");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1a70f05",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1a70f05",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public java.lang.String getDefBillType(){
 ...
 return (java.lang.String)context.get("defBillType");
  java.lang.String bean = new java.lang.String("F0");  context.put("defBillType",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public java.lang.String getDefNodeKey(){
 ...
 return (java.lang.String)context.get("defNodeKey");
  java.lang.String bean = new java.lang.String("D0");  context.put("defNodeKey",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public java.lang.String getMdFullnameHead(){
 ...
 return (java.lang.String)context.get("mdFullnameHead");
  java.lang.String bean = new java.lang.String("arap.recbill");  context.put("mdFullnameHead",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public java.lang.String getMdFullnameBody(){
 ...
 return (java.lang.String)context.get("mdFullnameBody");
  java.lang.String bean = new java.lang.String("arap.recitem");  context.put("mdFullnameBody",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

public nc.ui.arap.actions.RecLineDefValUtil getIArapLineDefValUtil(){
 if(context.get("iArapLineDefValUtil")!=null)
 return (nc.ui.arap.actions.RecLineDefValUtil)context.get("iArapLineDefValUtil");
  nc.ui.arap.actions.RecLineDefValUtil bean = new nc.ui.arap.actions.RecLineDefValUtil();
...
public nc.ui.arap.model.ReceivableBillAppModelService getManageModelService(){
 if(context.get("ManageModelService")!=null)
 return (nc.ui.arap.model.ReceivableBillAppModelService)context.get("ManageModelService");
  nc.ui.arap.model.ReceivableBillAppModelService bean = new nc.ui.arap.model.ReceivableBillAppModelService();
...
public nc.ui.arap.model.ReceivableBillPaginationQueryService getPaginationQueryService(){
 if(context.get("paginationQueryService")!=null)
 return (nc.ui.arap.model.ReceivableBillPaginationQueryService)context.get("paginationQueryService");
  nc.ui.arap.model.ReceivableBillPaginationQueryService bean = new nc.ui.arap.model.ReceivableBillPaginationQueryService();
...
public nc.ui.arap.view.ReceivableBillDefValue getBillDefVauleItf(){
 if(context.get("billDefVauleItf")!=null)
 return (nc.ui.arap.view.ReceivableBillDefValue)context.get("billDefVauleItf");
  nc.ui.arap.view.ReceivableBillDefValue bean = new nc.ui.arap.view.ReceivableBillDefValue();
...
public nc.ui.arap.actions.TransTypeAction getTranstype(){
 ...
 return (nc.ui.arap.actions.TransTypeAction)context.get("transtype");
  ...
  bean.setWherepart(" parentbilltype ='F0' and pk_group != 'global00000000000000'");
  bean.setEditor(getBillFormEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.arap.actions.BillApproveAction getApproveActionReal(){
 ...
 return (nc.ui.arap.actions.BillApproveAction)context.get("ApproveActionReal");
  nc.ui.arap.actions.BillApproveAction bean = new nc.ui.arap.actions.BillApproveAction();
...
public nc.ui.arap.actions.BillListApproveAction getApproveListActionReal(){
 ...
 return (nc.ui.arap.actions.BillListApproveAction)context.get("ApproveListActionReal");
  ...
  bean.setIsbatch("N");
  bean.setInterceptor(getInterceptor());
  bean.setTpaProgressUtil(getTPAProgressUtil_cb4c94());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.uif2.components.progress.TPAProgressUtil getTPAProgressUtil_cb4c94(){
 if(context.get("nc.ui.uif2.components.progress.TPAProgressUtil#cb4c94")!=null)
 return (nc.ui.uif2.components.progress.TPAProgressUtil)context.get("nc.ui.uif2.components.progress.TPAProgressUtil#cb4c94");
  nc.ui.uif2.components.progress.TPAProgressUtil bean = new nc.ui.uif2.components.progress.TPAProgressUtil();
  context.put("nc.ui.uif2.components.progress.TPAProgressUtil#cb4c94",bean);
  bean.setContext(getContext());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.arap.actions.BillListApproveAction getApproveListBatchActionReal(){
 ...
 return (nc.ui.arap.actions.BillListApproveAction)context.get("ApproveListBatchActionReal");
  nc.ui.arap.actions.BillListApproveAction bean = new nc.ui.arap.actions.BillListApproveAction();
  ...
  bean.setIsbatch("Y");
  bean.setInterceptor(getInterceptor());
  bean.setTpaProgressUtil(getTPAProgressUtil_110b824());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.uif2.components.progress.TPAProgressUtil getTPAProgressUtil_110b824(){
 if(context.get("nc.ui.uif2.components.progress.TPAProgressUtil#110b824")!=null)
 return (nc.ui.uif2.components.progress.TPAProgressUtil)context.get("nc.ui.uif2.components.progress.TPAProgressUtil#110b824");
  nc.ui.uif2.components.progress.TPAProgressUtil bean = new nc.ui.uif2.components.progress.TPAProgressUtil();
  context.put("nc.ui.uif2.components.progress.TPAProgressUtil#110b824",bean);
  bean.setContext(getContext());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.arap.actions.BillDeleteAction getDeleteActionReal(){
 ...
 return (nc.ui.arap.actions.BillDeleteAction)context.get("deleteActionReal");
...
private Map getManagedMap1(){  Map map = new HashMap();  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyBeforeEditEvent",getManagedList32());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyAfterEditEvent",getManagedList33());  map.put("nc.ui.arap.viewhandler.CardBodyAfterEditEvent",getManagedList34());  map.put("nc.ui.arap.viewhandler.cardafter.CardBodyAfterEditCalTaxEvent",getManagedList35());  map.put("nc.ui.arap.viewhandler.cardafter.CardBodyAfterEditTaxShowEvent",getManagedList36());  map.put("nc.ui.pubapp.uif2app.event.card.CardHeadTailBeforeEditEvent",getManagedList37());  map.put("nc.ui.pubapp.uif2app.event.card.CardHeadTailAfterEditEvent",getManagedList38());  map.put("nc.ui.pubapp.uif2app.event.card.CardPanelLoadEvent",getManagedList39());  map.put("nc.ui.pubapp.uif2app.event.list.ListPanelLoadEvent",getManagedList40());  map.put("nc.ui.pubapp.uif2app.event.list.ListHeadRowChangedEvent",getManagedList41());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyRowChangedEvent",getManagedList42());  map.put("nc.ui.pubapp.uif2app.event.list.ListHeadDataChangedEvent",getManagedList43());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyAfterRowEditEvent",getManagedList44());  map.put("nc.ui.pubapp.uif2app.mediator.mutiltrans.NodekeyEvent",getManagedList45());  return map;}

private List getManagedList32(){  List list = new ArrayList();  list.add(getBodyBankAccBeforeEditHandler());  list.add(getBodyAccountRefBeforeEditHandler());  list.add(getBodyFreeCustBeforeEditHandler());  list.add(getBodyProjectBeforeEditHandler());  list.add(getOtherOrgBodyBeforeEditHandler());  list.add(getPayTermBodyBeforeEditHandler());  list.add(getBodyCrossCheckBeforeHandler());  list.add(getBodySummaryBeforeEditHandler());  list.add(getBodyVersionRefBeforeEditHandler());  list.add(getBodySoBilltypeBeforeEditHandler());  list.add(getBodyCostCenterRefBeforeEditHandler());  list.add(getBodyTaxcodeBeforeEditHandler());  list.add(getBodyPsnDocBeforeEditHandler());  return list;}

private List getManagedList33(){  List list = new ArrayList();  list.add(getBodyAutoAddLineBeforeEditHandler());  list.add(getBodyMaterialAfterEditHandler());  list.add(getBodyPsnDocAfterEditHandler());  list.add(getBodyCurrTypeAfterEditHandler());  list.add(getBodyLocalMoneyAfterEditHandler());  list.add(getBodyRateAfterEditHandler());  list.add(getCardAfterEditCalculateHandler());  list.add(getBodyEuroAfterEditHandler());  list.add(getOtherOrgBodyAfterEditHandler());  list.add(getBodyMoneyBalanceAfterEditHandler());  list.add(getBodyMoneyBalanceAfterEditHandler());  list.add(getEnableCtrlBodyAfterEditHandler());  list.add(getBodyFundplanAfterEditHandler());  list.add(getBodyCuspAfterEditHandler());  list.add(getBodyBankAccAfterEditHandler());  list.add(getBodyDeptAfterEditHandler());  list.add(getBodyVersionRefAfterEditHandler());  list.add(getBodyCostCenterAfterEditHandler());  return list;}
...
private List getManagedList35(){  List list = new ArrayList();  list.add(getCardAfterEditCalculateHandler());  return list;}

private List getManagedList36(){  List list = new ArrayList();  list.add(getTaxForm());  return list;}

private List getManagedList37(){  List list = new ArrayList();  list.add(getHeadBankAccBeforeEditHandler());  list.add(getOtherOrgHeadBeforeEditHandler());  list.add(getHeadCrossCheckBeforeHandler());  list.add(getHeadSummaryBeforeEditHandler());  list.add(getHeadVersionRefBeforeEditHandler());  list.add(getHeadCostCenterRefBeforeEditHandler());  list.add(getHeadAccountRefBeforeEditHandler());  list.add(getHeadPsnDocBeforeEditHandler());  return list;}

private List getManagedList38(){  List list = new ArrayList();  list.add(getHBRelationAfterEditHandler());  list.add(getHeadCurrTypeAfterEditHandler());  list.add(getOtherOrgHeadAfterEdithandler());  list.add(getObjTypeHeadAfterEdithandler());  list.add(getHeadPsnDocAfterEditHandler());  list.add(getHeadFundplanAfterEditHandler());  list.add(getHeadCuspAfterEditHandler());  list.add(getHeadDeptAfterEditHandler());  list.add(getHeadVersionRefAfterEditHandler());  list.add(getHeadEuroAfterEditHandler());  list.add(getHeadCostCenterAfterEditHandler());  list.add(getHeadBillDateAfterEditHandler());  return list;}

private List getManagedList39(){  List list = new ArrayList();  list.add(getLoadBillCardTemplate());  return list;}
...
private List getManagedList42(){  List list = new ArrayList();  list.add(getCardBodyRowChangeHandler());  list.add(getSideFormMediator());  return list;}

private List getManagedList43(){  List list = new ArrayList();  list.add(getListHeadModelListener());  return list;}

private List getManagedList44(){  List list = new ArrayList();  list.add(getCardBodyAfterRowEditHandler());  return list;}

private List getManagedList45(){  List list = new ArrayList();  list.add(getAddActionGroup());  list.add(getTranstype());  return list;}
...
public nc.ui.arap.listener.RecBillRelationQueryDataListener getInitDataListener(){
 if(context.get("InitDataListener")!=null)
 return (nc.ui.arap.listener.RecBillRelationQueryDataListener)context.get("InitDataListener");
  nc.ui.arap.listener.RecBillRelationQueryDataListener bean = new nc.ui.arap.listener.RecBillRelationQueryDataListener();
  context.put("InitDataListener",bean);
  bean.setBillFormEditor(getBillFormEditor());
  bean.setListview(getListView());
  bean.setContext(getContext());
  bean.setModel(getManageAppModel());
  bean.setVoClassName("nc.vo.arap.receivable.AggReceivableBillVO");
...
private java.lang.String getI18nFB_bebab3(){
 if(context.get("nc.ui.uif2.I18nFB#bebab3")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#bebab3");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#bebab3",bean);  bean.setResDir("2006pub_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#bebab3",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList46(){  List list = new ArrayList();  list.add(getDocumentManage());  list.add(getTaxinfoLinkQueryAction());  list.add(getGoldentaxAction());  return list;}

public nc.ui.arap.actions.LinkQueryTaxInfoAction getTaxinfoLinkQueryAction(){
 if(context.get("taxinfoLinkQueryAction")!=null)
 return (nc.ui.arap.actions.LinkQueryTaxInfoAction)context.get("taxinfoLinkQueryAction");
  nc.ui.arap.actions.LinkQueryTaxInfoAction bean = new nc.ui.arap.actions.LinkQueryTaxInfoAction();
  context.put("taxinfoLinkQueryAction",bean);
  bean.setModel(getManageAppModel());
  bean.setEditor(getBillFormEditor());
  bean.setInterceptor(getInterceptor());
setBeanFacotryIfBeanFacatoryAware(bean);
...
public nc.funcnode.ui.action.MenuAction getBillAssistantActionGroup_List(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billAssistantActionGroup_List");
  ...
  bean.setCode("billAssistant");
  bean.setName(getI18nFB_1b0fad9());
...
private java.lang.String getI18nFB_1b0fad9(){
 if(context.get("nc.ui.uif2.I18nFB#1b0fad9")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1b0fad9");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1b0fad9",bean);  bean.setResDir("2006pub_0");
  bean.setResId("02006pub-0643");
  bean.setDefaultValue("辅助功能");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1b0fad9",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList47(){  List list = new ArrayList();  return list;}

public nc.ui.arap.importable.ReceivableImportablePanel getImportableEditor(){
 if(context.get("importableEditor")!=null)
 return (nc.ui.arap.importable.ReceivableImportablePanel)context.get("importableEditor");
  nc.ui.arap.importable.ReceivableImportablePanel bean = new nc.ui.arap.importable.ReceivableImportablePanel();
...
private java.lang.String getI18nFB_24df47(){
 if(context.get("nc.ui.uif2.I18nFB#24df47")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#24df47");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#24df47",bean);  bean.setResDir("2006pub_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#24df47",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList48(){  List list = new ArrayList();  list.add(getImportAction());  list.add(getCurrNullAction());  list.add(getExportAction());  return list;}

public nc.ui.arap.actions.ExportGoldenTaxAction getGoldentaxAction(){
 if(context.get("goldentaxAction")!=null)
 return (nc.ui.arap.actions.ExportGoldenTaxAction)context.get("goldentaxAction");
  nc.ui.arap.actions.ExportGoldenTaxAction bean = new nc.ui.arap.actions.ExportGoldenTaxAction();
  context.put("goldentaxAction",bean);
  bean.setModel(getManageAppModel());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private List getManagedList49(){  List list = new ArrayList();  list.add(getAddActionGroup());  list.add(getEditAction());  list.add(getDeleteAction());  list.add(getCopyAction());  list.add(getCurrNullAction());  list.add(getQueryAction());  list.add(getRefreshAllAction());  list.add(getCurrNullAction());  list.add(getTranstype());  list.add(getBillApproveActionGroup_List());  list.add(getBillVerifyActionGroup());  list.add(getMadeBillAction());  list.add(getWriteBack());  list.add(getPauseTransactActionGroup());  list.add(getBillAssistantActionGroup());  list.add(getCurrNullAction());  list.add(getReceiptMenuAction());  list.add(getCurrNullAction());  list.add(getRelatedQueryActionGroup());  list.add(getCurrNullAction());  list.add(getImportexportActionGroup());  list.add(getPrintOperateActionGroup_List());  return list;}
...
public nc.ui.uif2.actions.StandAloneToftPanelActionContainer getCardActions(){
 ...
 return (nc.ui.uif2.actions.StandAloneToftPanelActionContainer)context.get("cardActions");
  ...
  bean.setEditActions(getManagedList51());
  bean.setModel(getManageAppModel());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private List getManagedList50(){  List list = new ArrayList();  list.add(getAddActionGroup());  list.add(getEditAction()); 
list.add(getDeleteAction());  list.add(getCopyAction());  list.add(getCurrNullAction());  list.add(getQueryAction()); 
list.add(getRefreshSingAction());  list.add(getCurrNullAction());  list.add(getTranstype());  list.add(getBillApproveActionGroup()); 
list.add(getBillVerifyActionGroup());  list.add(getMadeBillAction());  list.add(getWriteBack());  list.add(getPauseTransactActionGroup());  
list.add(getBillAssistantActionGroup());  list.add(getCurrNullAction());  list.add(getReceiptMenuAction());  list.add(getCurrNullAction());  
list.add(getRelatedQueryActionGroup());  list.add(getCurrNullAction());  list.add(getImportexportActionGroup());
...
private List getManagedList51(){  List list = new ArrayList();  list.add(getSaveAction());  list.add(getTempSaveAction());  
list.add(getCurrNullAction());  list.add(getCancelAction());  list.add(getCurrNullAction());  list.add(getDocumentManage());  
 ...
 * @date 2017-7-6
 */
public nc.ui.arap.actions.SendMailAction getSendMailAction(){
	 if(context.get("sendMailAction")!=null)
	 return (nc.ui.arap.actions.SendMailAction)context.get("sendMailAction");
	 nc.ui.arap.actions.SendMailAction bean = new nc.ui.arap.actions.SendMailAction();
